...
//	}
	...
	@Autowired
	com.cg.marriageceremony.repository.PaymentRepository  payRepo;
	
	@PreAuthorize("hasAuthority('User')")
	@GetMapping("/pay/totalcost")
	public float findTotalCost(Principal p) {
		int cid= payRepo.findCustId(p.getName());
		float price = paymentService.getTotalAmount(cid);
		return price;
	}
